...
switch ((string) $item->text)
{
	...
	case Text::_('JLIB_HTML_START') :
		$icon = $app->getLanguage()->isRtl() ? 'far fa-chevron-double-right' : 'far fa-chevron-double-left';
	...
	case $item->text === Text::_('JPREV') :
		...
		$icon = $app->getLanguage()->isRtl() ? 'far fa-chevron-right' : 'far fa-chevron-left';
		$aria =Text::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
		break;

	// Check for "Next" item
	case Text::_('JNEXT') :
		$icon = $app->getLanguage()->isRtl() ? 'far fa-chevron-left' : 'far fa-chevron-right';
		$aria = Text::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
		break;

	// Check for "End" item
	case Text::_('JLIB_HTML_END') :
		$icon = $app->getLanguage()->isRtl() ? 'far fa-chevron-double-left' : 'far fa-chevron-double-right';
		$aria = Text::sprintf('JLIB_HTML_GOTO_POSITION', strtolower($item->text));
		break;
