...
$attributes = array(
	...
	!empty($class) ? 'class="uk-input form-control ' . $class . '"' : 'class="form-control"',
...
<div class="password-group">
	<div class="input-group uk-position-relative">
		...
		<?php if (!$lock): ?>
		<button type="button" class="btn btn-secondary input-password-toggl uk-position-center-left uk-hidden" data-uk-tooltip="<?php echo Text::_('JSHOWPASSWORD'); ?>">
