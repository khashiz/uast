...
<div class="uk-child-width-1-1 uk-grid-divider com-content-category-blog blog" itemscope itemtype="https://schema.org/Blog" data-uk-grid>
	...
	<?php if (!empty($this->lead_items)) : ?>
        <div>
            <div class="uk-grid-divider uk-grid-small uk-child-width-1-1 com-content-category-blog__items blog-items items-leading <?php echo $this->params->get('blog_class_leading'); ?>" data-uk-grid>
