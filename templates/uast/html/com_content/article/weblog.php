...
<div class="uk-grid-column-small uk-grid-row-medium uk-grid-match" data-uk-grid>
    ...
    <div class="uk-width-1-1 uk-width-expand@s">
        <ul class="uk-grid-small uk-child-width-1-4 uk-child-width-auto@m" data-uk-grid>
            <li><a href="https://www.facebook.com/sharer.php?u=<?php echo JURI::current(); ?>" target="_blank" class="uk-button-social uk-button uk-border-rounded uk-box-shadow-small uk-flex uk-flex-center uk-flex-middle uk-padding-small uk-button-facebook"><i class="fab fa-facebook"></i></a></li>
            <li><a href="https://twitter.com/share?url=<?php echo JURI::current(); ?>&text=<?php echo $this->escape($this->item->title); ?>" target="_blank" class="uk-button-social uk-button uk-border-rounded uk-box-shadow-small uk-flex uk-flex-center uk-flex-middle uk-padding-small uk-button-twitter"><i class="fab fa-twitter"></i></a></li>
            <li><a href="tg://msg_url?url=<?php echo JURI::current(); ?>&text=<?php echo $this->escape($this->item->title); ?>" target="_blank" class="uk-button-social uk-button uk-border-rounded uk-box-shadow-small uk-flex uk-flex-center uk-flex-middle uk-padding-small uk-button-telegram"><i class="fab fa-telegram"></i></a></li>
