...
?>
<div class="com-users-reset-complete reset-complete uk-width-1-1 uk-width-1-2@s">
	...
	<form action="<?php echo Route::_('index.php?option=com_users&task=reset.complete'); ?>" method="post" class="com-users-reset-complete__form form-validate form-horizontal well">
		...
		<?php endforeach; ?>
		<div class="com-users-reset-complete__submit control-group uk-width-1-1 uk-width-auto@s uk-grid-margin-medium">
			<div class="controls">
