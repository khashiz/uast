...
<?php if (($this->total === 0) || ($this->total === null)) : ?>
	<div id="search-result-empty" class="uk-text-center com-finder__empty">
		<h2 class="uk-text-black font f700"><?php echo Text::_('COM_FINDER_SEARCH_NO_RESULTS_HEADING'); ?></h2>
		<?php $multilang = Factory::getApplication()->getLanguageFilter() ? '_MULTILANG' : ''; ?>
		<p class="font uk-text-muted f500 uk-text-small"><?php echo Text::sprintf('COM_FINDER_SEARCH_NO_RESULTS_BODY' . $multilang, $this->escape($this->query->input)); ?></p>
	</div>
...
<ol id="search-result-list" class="uk-list uk-list-divider uk-list-collapse js-highlight" start="<?php echo (int) $this->pagination->limitstart + 1; ?>">
...
<div class="com-finder__navigation search-pagination uk-text-tiny font f500 uk-text-muted uk-margin-medium-top">
